...
import { n as navbarInjectionKey, g as globalCollapseStorageInjectionKey } from "./keys-CsqIkltC.mjs";
import { u as useColorVariantClasses } from "./useColorVariantClasses-ZDE19TZw.mjs";
import { _ as _sfc_main$4 } from "./BLink.vue_vue_type_script_setup_true_lang-BB8hwqOG.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const collapseData = inject(globalCollapseStorageInjectionKey, void 0);
    const collapseExpanded = computed(() => {
      var _a;
      if (!props.target || !collapseData) return false;
      if (typeof props.target === "string") return ((_a = collapseData.map[props.target]) == null ? void 0 : _a.value) || false;
...
//# sourceMappingURL=BNavbarToggle.vue_vue_type_script_setup_true_lang-CHv3aBZ-.mjs.map
